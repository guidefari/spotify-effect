...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./chunks/0-BO-eqf3q.js')),
			__memo(() => import('./chunks/1-CT7Hfso_.js')),
			__memo(() => import('./chunks/2-CkF8lsCD.js')),
			__memo(() => import('./chunks/3-ecDBTuV4.js'))
		],
		remotes: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-4dK5S0RH.js'))
			},
			{
				id: "/api/profile",
				pattern: /^\/api\/profile\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-BdLkwtGw.js'))
			},
			{
				id: "/api/track",
				pattern: /^\/api\/track\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-BEJDSqTr.js'))
			},
			{
				id: "/track",
				pattern: /^\/track\/?$/,
