...
export class Follow extends ServiceMap.Service<Follow, {
  readonly getFollowedArtists: (
    options?: GetFollowedArtistsOptions,
  ) => Effect.Effect<CursorBasedPaging<Artist>, SpotifyRequestError>;
  readonly followArtists: (artistIds: ReadonlyArray<string>) => Effect.Effect<void, SpotifyRequestError>;
  readonly unfollowArtists: (artistIds: ReadonlyArray<string>) => Effect.Effect<void, SpotifyRequestError>;
  readonly followUsers: (userIds: ReadonlyArray<string>) => Effect.Effect<void, SpotifyRequestError>;
  readonly unfollowUsers: (userIds: ReadonlyArray<string>) => Effect.Effect<void, SpotifyRequestError>;
