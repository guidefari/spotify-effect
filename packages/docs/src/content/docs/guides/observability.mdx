...
<Tabs>
  <TabItem label="bun">
    ```sh bun add @spotify-effect/otel-node @opentelemetry/exporter-trace-otlp-http
    @effect/opentelemetry ```
  </TabItem>
  <TabItem label="npm">
    ```sh npm install @spotify-effect/otel-node @opentelemetry/exporter-trace-otlp-http
    @effect/opentelemetry ```
  </TabItem>
</Tabs>
